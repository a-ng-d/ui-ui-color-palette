...
export const setContexts = (
  ...
  const contexts: Array<{
    ...
    {
      label: locales('contexts.imports'),
      id: 'IMPORTS',
      isUpdated: false,
      isNew: featuresList.IMPORTS.isNew(),
      isActive: featuresList.IMPORTS.isActive(),
    },
    {
    ...
    {
      label: locales('contexts.report'),
      id: 'REPORT',
      isUpdated: false,
      isNew: featuresList.REPORT.isNew(),
      isActive: featuresList.REPORT.isActive(),
    },
    {
