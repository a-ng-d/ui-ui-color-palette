...
export const featuresScheme: Array<Feature<Service>> = [
  ...
  {
    name: 'STRUCTURE',
    description: 'Service for defining the semantic structure of a palette',
    isActive: true,
    isPro: false,
    isNew: false,
    type: 'SERVICE',
  ...
  {
    name: 'TAXONOMY',
    description: 'Naming taxonomy configuration for the palette structure',
    isActive: true,
    isPro: false,
    isNew: false,
    type: 'CONTEXT',
  ...
  {
    name: 'BINDING',
    description: 'Binding of taxonomy paths to palette shades',
    isActive: true,
    isPro: false,
    isNew: false,
    type: 'CONTEXT',
  ...
  {
    name: 'VISUALIZE',
    description: 'Visualization of the palette structure',
    isActive: true,
    isPro: false,
    isNew: false,
    type: 'CONTEXT',
